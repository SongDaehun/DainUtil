...
Public Class FrmStandardMaster
    ...
    Private Sub frmCodesetMente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd = New SqlCommand("SELECT * FROM M_STANDARDCODENAME ORDER BY STANDARDNAME ", dbConn)
    ...
    Private Function setdetail() As Boolean
        ...
        Try
            ...
            While dr.Read
                ...
                DataGridView1.Rows(rowIndex).Cells(DataGridView1.ColumnCount - 1).Value = dr("CONTENTSCODE")
                rowIndex = rowIndex + 1
            End While
            cmd.Dispose()
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        ...
        Dim i As Integer = 0
        Try
            strSQL = " DELETE FROM M_STANDARDCODESET WHERE 1 = 1 AND CODEDIV = '" & cmbdatatable.Rows(cmbStandard.SelectedIndex)("STANDARDNAME") & "'"
            cmd = New SqlCommand(strSQL, dbConn)
            cmd.ExecuteNonQuery()
            ...
            While DataGridView1.Rows(i).Cells(1).Value &
                ...
                strSQL = "INSERT INTO M_STANDARDCODESET VALUES("
